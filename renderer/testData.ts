...
export const conversations: Conversation[] = [
  ...
  { id: 2, selectedModel: 'qwen-plus', title: '人工智能发展趋势与应用/人工智能发展趋势与123123132123123123123123', createdAt: randomDate(startDate, endDate), updatedAt: randomDate(startDate, endDate), providerId: 2, pinned: false },
